        ...
        void buildchart () {
            ...
            barChart.setRenderer(barChartRender);
                    ...
                    for (int i = 1; i <= barnum; i++) {
                        valueList.add(Double.valueOf(barDataMap.get(xDataTotal[0]).get(i)));


                    }

                    for (int i = 1; i <= barnum; i++) {
                        valueList2.add(Double.valueOf(barDataMap.get(xDataTotal[1]).get(i)));


                    }
                    for (int i = 1; i <= barnum; i++) {
                        valueList3.add(Double.valueOf(barDataMap.get(xDataTotal[2]).get(i)));


                    }
                    for (int i = 1; i <= barnum; i++) {
                        valueList4.add(Double.valueOf(barDataMap.get(xDataTotal[3]).get(i)));


                    }
                    for (int i = 1; i <= barnum; i++) {
                        valueList5.add(Double.valueOf(barDataMap.get(xDataTotal[4]).get(i)));
